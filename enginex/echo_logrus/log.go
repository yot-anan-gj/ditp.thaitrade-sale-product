...
// Singleton logger
var singletonLogger = &EchoLogrus{
	Logger: logrus.New(),
}

// Logger return singleton logger
func Logger() *EchoLogrus {
...
func (l *EchoLogrus) Formatter() logrus.Formatter {
	return l.Logger.Formatter
}

// SetFormatter logger formatter
// Only support logrus formatter
func (l *EchoLogrus) SetFormatter(formatter logrus.Formatter) {
